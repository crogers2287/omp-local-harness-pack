...
// AgentToolResult — local type to avoid @oh-my-pi/pi-agent-core import (v16 compat)
type AgentToolResult = { content: Array<{ type: string; text?: string }>; details?: unknown; isError?: boolean; };
// original: import type { AgentToolResult } from "@oh-my-pi/pi-agent-core";
